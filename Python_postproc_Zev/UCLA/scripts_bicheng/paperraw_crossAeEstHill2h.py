...
"""
Program: paperraw_crossAeEstHill2h
The crossection of TKE budget terms for the hill2h case
"""
...
fn_budget = './figure/paperraw/paperraw_crossAeEstHillh.png'
...
ticks = np.arange(levels_bdg[0], levels_bdg[-1]+0.1, 2.0) #.5
...
# # Calculate the MKE terms 
# items_mke = ('tt_x', 'tt_z', 'dt_x', 'dt_z','sgst_x', 'sgst_z', \
#              'sp_x', 'sp_z', 'dp_x', 'dp_z', 'adv_x', 'adv_z', 'pt_x', 'pt_z')
# terms_mke = [dict.fromkeys(items_mke, None) for ic in range(nca)]
# for ic in range(nca):
    
#     # Horizontal Contribution 
#     # Turbuluent Transport of MKE 
#     uuu = data[ic]['uu_t']*data[ic]['u']
#     terms_mke[ic]['tt_x'] = get_dphidx(uuu, wn[ic]) 
    
#     # Dispersive Transport of MKE 
#     # data[ic]['uu_d'] = np.mean(data[ic]['u']*data[ic]['w'], axis = 1) \
#     #     - np.mean(data[ic]['u'], axis = 1)*np.mean(data[ic]['w'], axis = 1)
#     # terms_mke[ic]['dt_x'] = get_dphidx(data[ic]['uu_d']*data[ic]['u'], wn[ic]) 
    
#     # SGS Transport 
#     utau = data[ic]['tau']*data[ic]['u']
#     terms_mke[ic]['sgst_x'] = get_dphidx(utau, wn[ic]) 
    
#     # Shear Proction 
#     terms_mke[ic]['sp_x'] = data[ic]['uu_t']*data[ic]['dudx']
