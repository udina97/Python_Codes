...
"""
Program: paperraw_crossTKEbudgetHill
The crossection of TKE budget terms for the hill case
"""
...
fn_budget = './figure/paperraw/paperraw_crossTKEbudgetHill.png'
...
for ic in range(nca):
  for ind in ind_plot:
    terms_bdg[ic][items_bdg[ind]] /= -(terms_bdg[ic]['dissip']
      +terms_bdg[ic]['canopy'])
...
for ic in range(nca):
  ...
  fn_npz = "./data/forpaper/fig4_crossTKEbudget_{case:s}".format(case=nm_case[ic])
