...
def phi_m(Nx,Ny,Nz_SLayer,height,z_d,z_grid,u,v,avgdUdz,avgdVdz,Rxz,SGSxz,Ryz,SGSyz):
    ...
    for i in range(0,Nx):
        for j in range(0,Ny):
            ustar[i,j] = tmp_ustar[i,j,int(z_grid[i]+height)]
...
def phi_m_real(Nx,Ny,Nz_SLayer,height,z_d,z_grid,u,v,avgdUdz,avgdVdz,Rxz,SGSxz,Ryz,SGSyz):
    ...
    return(phi_m_3D,U,ustar,tmp_ustar)
