...
directory = '/uufs/chpc.utah.edu/common/home/calaf-group2/Ben_research/AnisotropyData/'

case = 'simATTO_256x256x384_full_out5hr'

# pathOUT = '/uufs/chpc.utah.edu/common/home/calaf-group2/Ben_research/AnisotropyData/' 

path_case = directory + case + '/'
...
with open(path_case+'data.pkl', 'rb') as f:
...
dataTKE.to_netcdf(path_case+'dataTKE.nc')