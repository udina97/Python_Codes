...
# Case
case = ('amazon_canopy_real', 'amazon_canopy_nohill')
lab_case = ('real', 'flat')
...
# %% ZU addidtions 
## Read data
lespath = fmt_lespath.format(case=case[0])
...
# z_gd  = np.linspace(0,dm.lz,dm.nz)
# x_gd  = np.linspace(0,dm.lx,dm.nx)
# y_gd  = np.linspace(0,dm.ly,dm.ny)
