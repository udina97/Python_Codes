...
"""
Program: paperraw_crossAeEstHill
...
fn_budget = './figure/paperraw/paperraw_crossAeEstHill.png'
...
for ic in range(nca):
  ...
  if ic == 0:
      ...
      plt.subplot(3,1,1)
      plt.contourf(terms_bdg[0]['adv_h'][1:100,:],levels_bdg*40)
      plt.colorbar()
      plt.title('advh-1')
      plt.set_cmap('seismic')
      plt.subplot(3,1,2)
      plt.contourf(terms_bdg[0]['adv_v'][1:100],levels_bdg)
      plt.colorbar()
      plt.title('advv')
      plt.set_cmap('seismic')
      plt.subplot(3,1,3)
      plt.contourf(terms_bdg[0]['adv'][1:100],levels_bdg)
      plt.colorbar()
      plt.title('adv')
      plt.set_cmap('seismic')
...
plt.figure(figsize =(10,8))
plt.subplot(3,1,1)
plt.contourf(terms_bdg[0]['adv_h'][1:100,:],levels_bdg)
plt.colorbar()
plt.title('advh-2')
plt.set_cmap('seismic')
plt.subplot(3,1,2)
...
for ic in range(nca):
  ...
  if ic == 0:
      total_dissip_hill = total_dissip
