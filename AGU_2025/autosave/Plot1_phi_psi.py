...
ax_top.set_ylabel(r"$\phi_M$",fontsize=14)
# cbar = plt.colorbar(p)
...
ax_top.axhline(1,c='k',ls='--')
ax_top.set_ylabel(r"$\phi_M$",fontsize=16)
# cbar = plt.colorbar(p)
ax_bot.scatter(bin_centers, ratio[:-1]*100, s=10, c='b')
ax_bot.set_ylabel(r"$\frac{<\phi_a - \phi_r>}{<\phi_r>}$ [%]", fontsize=14)
ax_bot.set_xlabel(r"$\zeta$", fontsize=16)
ax_bot.set_xscale('log')
ax_bot.axhline(0,c='k',ls='--')
for i in range(nbins):
    ax_bot.axvline(bins[i], c='k', ls=':')
...
ax_top.invert_xaxis()
ax_top.axhline(1,c='k',ls='--')
ax_top.set_ylabel(r"$\phi_H$",fontsize=16)
# cbar = plt.colorbar(p)
ax_bot.scatter(bin_centers, ratio[:-1]*100, s=10, c='b')
ax_bot.set_ylabel(r"$\frac{<\phi_a - \phi_r>}{<\phi_r>}$ [%]", fontsize=14)
ax_bot.set_xlabel(r"$-\zeta$", fontsize=16)
...
ax_top.axvline(14.513,c='k',ls='--')
ax_top.axhline(1,c='k',ls='--')
ax_top.set_ylabel(r"$\psi_M$",fontsize=14)
# cbar = plt.colorbar(p)
ax_bot.scatter(bin_centers, ratio[:-1]*100, s=10, c='b')
ax_bot.set_ylabel(r"$\frac{<\psi_a - \psi_r>}{<\psi_r>}$ [%]", fontsize=14)
ax_bot.set_xlabel(r"$-\zeta$", fontsize=14)
ax_bot.set_xscale('log')
...
ax_top.set_ylabel(r"$\psi_H$",fontsize=14)
# cbar = plt.colorbar(p)
ax_bot.scatter(bin_centers, ratio[:-1]*100, s=10, c='b')
ax_bot.set_ylabel(r"$\frac{<\psi_a - \psi_r>}{<\psi_r>}$ [%]", fontsize=14)
ax_bot.set_xlabel(r"$-\zeta$", fontsize=14)
