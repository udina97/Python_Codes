...
## User-specified Variablesss
case = 'amazon_canopy_real'
# File
fmt_lespath = '/uufs/chpc.utah.edu/common/home/calaf-group3/UCLA_data/{case:s}'
fmt_out = '/uufs/chpc.utah.edu/common/home/calaf-group3/UCLA_data/data/amazon_canopy_flat_3D/ \
statistics3D_{case:s}_tt{tts:08d}-{tte:08d}.npz'
...
# %%
# for var in var_list:
#     np.save(path + var, data[var])
# %%
dataL = {}
for var in var_list:
    dataL[var] = np.load(path + var + '.npy')
