...
z_grid = np.ones((Nx,Ny),'d',order='F') #vector needed to take ustar 1 grid point above the top of the canopy in phi_m func
...
path_fig = '/Users/mcalaf/Documents/Utah/Research/Collaborative_Research/Gaby-Marcelo/BichengTKE/amazon_canopy_flat_3D/Figures/'
...
fig, axs = plt.subplots(1,1,figsize=(4,4)) #figsize=(width,height)
norm = mpl.colors.BoundaryNorm(np.arange(0,1,0.1),cmap.N)
plt.ion()
...
#plt.savefig(path_fig+'Sigma_u_mean_shading.png',dpi=300,facecolor='white',edgecolor='white')
