...
from functions import tavg_xy, terrainfollowing_2D, read_out_files
...
path = '/uufs/chpc.utah.edu/common/home/calaf-group3/UCLA_data/data/amazon_canopy_flat_3D/'
...
#Amazon Hill Canopy
Nx = 320; Ny = 160; Nz = 260; Nz_SLayer = int(Nz/2)
...
path_in = '/uufs/chpc.utah.edu/common/home/calaf-group3/UCLA_data/amazon_canopy_nohill/output/'
path_out = '/uufs/chpc.utah.edu/common/home/calaf-group2/Ben_research/UCLAdata/amazon_canopy_flat/'
...
var = 'w'
# var2 = 'avgW'
# tmp = copy.deepcopy(data_tavg['p']-0.5*(data_tavg['u2']+data_tavg['v2']+data_tavg['w2']))
...
axs[0,0].plot(np.mean(Rij['Rxx'],axis=(0)),z_ax)
axs[0,1].plot(np.mean(Rij['Ryy'],axis=(0)),z_ax)
axs[0,2].plot(np.mean(Rij['Rzz'],axis=(0)),z_ax)
axs[1,0].plot(np.mean(Rij['Rxy'],axis=(0)),z_ax)
axs[1,1].plot(np.mean(Rij['Rxz'],axis=(0)),z_ax)
axs[1,2].plot(np.mean(Rij['Ryz'],axis=(0)),z_ax)
...
#%% Calculate the TKE budget: Approach 1 (compute the 2D terms and then space average)
...
z_ax = np.arange(0,Nz)*dm.dz/canopyH#(dm.dz/dm.zi)
...
# plt.savefig(path_out+'/Figures/yB.png',dpi=300,facecolor='white', edgecolor='white')
...
# plt.savefig(path_out+'/Figures/AD_yB_scat.png',dpi=300,facecolor='white', edgecolor='white')
...
# plt.savefig(path_out+'/Figures/TKE_yB.png',dpi=300,facecolor='white', edgecolor='white')
...
# coord = [(80),(240)]
coord = [(160),(120),(100),(80),(60),(55),(50),(45),(40),(35),(30),(25),(20),(15),(10),(5),(1)]
...
#%% Dispersive TKE Terms:

def XYavg_withTopo(phi,dist):
...
def DispFluct_withTopo(phi,dist,dm):
  phi[(dist < 0)] = float("nan")
...
terms_avgdrv['du_avgdz'] = get_dphi_avgdz(XYavg_withTopo(data_tavg['u'],dist), dm)
terms_avgdrv['du_avgdz'] = XYavg_wnode2uvpnode(terms_avgdrv['du_avgdz'])
terms_avgdrv['dv_avgdz'] = get_dphi_avgdz(XYavg_withTopo(data_tavg['v'],dist), dm)
terms_avgdrv['dv_avgdz'] = XYavg_wnode2uvpnode(terms_avgdrv['dv_avgdz'])
terms_avgdrv['dw_avgdz'] = get_dphi_avgdz(XYavg_withTopo(data_tavg['w'],dist), dm)
...
terms_Dispbdg['prod'] = -(XYavg_withTopo(terms_ptb['uw_t'],dist)*terms_avgdrv['du_avgdz'] 
                            + XYavg_withTopo(terms_ptb['vw_t'],dist)*terms_avgdrv['dv_avgdz']
                            + XYavg_withTopo(terms_ptb['w2_t'],dist)*terms_avgdrv['dw_avgdz']
                            + XYavg_withTopo(data_tavg['txz'],dist)*terms_avgdrv['du_avgdz']
                            + XYavg_withTopo(data_tavg['tyz'],dist)*terms_avgdrv['dv_avgdz']
                            + XYavg_withTopo(data_tavg['tzz'],dist)*terms_avgdrv['dw_avgdz']
                            )

print('Calculating the Dispersive production term')


terms_DispCorr['prodCorr'] = -( (DispFluct_withTopo(terms_ptb['uw_t'],dist,dm)*DispFluct_withTopo(terms_drv['dudz'],dist,dm)) 
                           + (DispFluct_withTopo(terms_ptb['vw_t'],dist,dm)*DispFluct_withTopo(terms_drv['dvdz'],dist,dm))
                           + (DispFluct_withTopo(terms_ptb['w2_t'],dist,dm)*DispFluct_withTopo(terms_drv['dwdz'],dist,dm))
                           + (DispFluct_withTopo(terms_ptb['u2_t'],dist,dm)*DispFluct_withTopo(terms_drv['dudx'],dist,dm))
                           + (DispFluct_withTopo(terms_ptb['uv_t'],dist,dm)*DispFluct_withTopo(terms_drv['dvdx'],dist,dm))
                           + (DispFluct_withTopo(terms_ptb['uw_t'],dist,dm)*DispFluct_withTopo(terms_drv['dwdx'],dist,dm))
                           + (DispFluct_withTopo(data_tavg['txz'],dist,dm)*DispFluct_withTopo(terms_drv['dudz'],dist,dm)) 
                           + (DispFluct_withTopo(data_tavg['tyz'],dist,dm)*DispFluct_withTopo(terms_drv['dvdz'],dist,dm))
                           + (DispFluct_withTopo(data_tavg['tzz'],dist,dm)*DispFluct_withTopo(terms_drv['dwdz'],dist,dm))
                           + (DispFluct_withTopo(data_tavg['txx'],dist,dm)*DispFluct_withTopo(terms_drv['dudx'],dist,dm))
                           + (DispFluct_withTopo(data_tavg['txy'],dist,dm)*DispFluct_withTopo(terms_drv['dvdx'],dist,dm))
                           + (DispFluct_withTopo(data_tavg['txz'],dist,dm)*DispFluct_withTopo(terms_drv['dwdx'],dist,dm))
                           )

terms_Dispbdg['Dprod'] = XYavg_withTopo(terms_DispCorr['prodCorr'],dist)
...
terms_Dispbdg['Ttransp'] =  get_dphi_avgdz(XYavg_withTopo(tmp,dist),dm)
...
terms_DispCorr['transpCorr'] = - get_dphidz(DispFluct_withTopo(data_tavg['w'],dist,dm)*(DispFluct_withTopo(terms_ptb['tke'],dist,dm)+DispFluct_withTopo(terms_ptb['tke_SGS'],dist,dm)),dm)
terms_Dispbdg['Dtransp'] =  XYavg_withTopo(terms_DispCorr['transpCorr'],dist)
...
# plt.plot(np.mean(terms_bdg['res']/(-terms_bdg['totdis']),axis=(0)),z_ax,c='pink',marker='o',markevery=5,label='res')
# plt.plot(np.mean(terms_bdg['adv']/(-terms_bdg['totdis']),axis=(0)),z_ax,c='red',marker='s',markevery=5,label='Adv')
...
uw_d = np.nanmean(data_tavg['u']*data_tavg['w'],axis=(0)) - np.nanmean(data_tavg['u'],axis=(0))*np.nanmean(data_tavg['w'],axis=(0))

z_ax = np.arange(0,Nz)*dm.dz/h_canopy#(dm.dz/dm.zi)

plt.figure(figsize=(4,8))
# plt.plot(np.nanmean(terms_ptb['uw_t'],axis=(0)),z_ax,c='pink',marker='o',markevery=5,label='<uw_t>')
plt.plot(uw_d,z_ax,c='pink',marker='o',markevery=5,label='uw_d')
# plt.hlines(h_canopy/h_canopy,-60,80,linestyle='--',colors='k')
# plt.hlines(2*(h_canopy/h_canopy),-60,80,linestyle='--',colors='k')
# plt.vlines(1,0,5,linestyle='--',colors='grey')
# plt.vlines(-1,0,5,linestyle='--',colors='grey')
