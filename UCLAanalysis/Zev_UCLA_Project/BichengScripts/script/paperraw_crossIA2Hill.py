...
"""
Program: paperraw_crossIAHill
The crossection of IA terms for the hill case
"""
...
fn_budget = './figure/paperraw/paperraw_crossIA2Hill.png'
...
items_bdg = ('dissip', 'canopy', 'IA')
labs_bdg = (r'$\epsilon$', r'$\epsilon_c$', r'$|A_e|$')
ind_plot = [2, ]
...
for ic in range(nca):
  ...
  terms_bdg[ic]['IA'] = np.abs(-duedx-dwedz)
