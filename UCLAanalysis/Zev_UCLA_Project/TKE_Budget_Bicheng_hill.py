...
path = '/uufs/chpc.utah.edu/common/home/calaf-group3/UCLA_data/data/amazon_canopy_hill_3D/'
...
#Amazon Hill Canopy
Nx = 320; Ny = 160; Nz = 270; Nz_SLayer = int(Nz/2)
Lx = 2000; Ly = 1000; Lz = 540
Zi = 540
...
path_in = '/uufs/chpc.utah.edu/common/home/calaf-group3/UCLA_data/amazon_canopy_hill/output/'
path_out = '/uufs/chpc.utah.edu/common/home/calaf-group2/Ben_research/UCLAdata/amazon_canopy_hill/'
...
# for i in range(len(var_ptb)):
#     terms_ptb[var_ptb[i]][(dist < 0)] = float("nan")
...
axs[0].plot(np.nanmean(data_tavg['u'],axis=(0)),z_ax,label='u')
axs[1].plot(np.nanmean(data_tavg['v'],axis=(0)),z_ax,label='v')
axs[2].plot(np.nanmean(data_tavg['w'],axis=(0)),z_ax,label='w')
...
path_fig = '/uufs/chpc.utah.edu/common/home/u1450851/Pictures/UCLA_tke/hill/'
...
# plt.savefig(path_out+'/Figures/yB_cluster.png',dpi=300,facecolor='white', edgecolor='white')
...
# plt.plot(np.nanmean(terms_topo['ttrans'],axis=(0)),z_ax,c='black',marker='s',markevery=5,label='<T>')
plt.hlines(h_canopy/h_canopy,-60,80,linestyle='--',colors='k')
plt.hlines(2*(h_canopy/h_canopy),-60,80,linestyle='--',colors='k')
plt.ylim(0,10)
plt.xlim(-40,60)
